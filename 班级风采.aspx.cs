...
namespace photo
{
    public partial class 班级风采 : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
             ...
             if (string.IsNullOrEmpty(TextBox6.Text))
            {
             ...
             string sql = "INSERT INTO 班级风采 (图片名称,图片的路径,图片描述) VALUES ('" + TextBox1.Text.Trim() + "','" + TextBox5.Text.Trim() + "','" + TextBox6.Text.Trim() + "')";
             //可以会发生异常的语句都放在这里 
             try
             {

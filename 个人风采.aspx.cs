...
namespace photo
{
    public partial class 个人风采 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
             ...
             if (string.IsNullOrEmpty(TextBox8.Text))
            {
             ...
             string sql = "INSERT INTO 个人风采 (图片名称,图片路径,图片描述) VALUES ('" + TextBox6.Text.Trim() + "','" + TextBox7.Text.Trim() + "','" + TextBox8.Text.Trim() + "')";
             //可以会发生异常的语句都放在这里 
             try
             {

...
<body bgcolor="#cc99ff">
    ...
    <td class="style1"> 
        ...
        <td>
            ...
            <asp:Button ID="Button2" runat="server" Text="班级风采" onclick="Button2_Click" />
        ...
        <tr>
            <td>
                <asp:Image ID="Image1" runat="server" Width="550px" 
                    ImageUrl="~/img/123.jpg" Height="418px" />
        ...
        <tr><td>
            <asp:Image ID="Image2" runat="server" Height="579px" ImageUrl="~/img/879.jpg" 
                Width="539px" />
